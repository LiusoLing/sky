...
public class BaseDbHelper {
    ...
    private final static String SQL_CREATE_TABLE = "CREATE TABLE IF NOT EXISTS #tableName("
            ...
            + "value bigint(20) NOT NULL COMMENT '初始位置',"
            + "name varchar(32) NOT NULL COMMENT '区间名称',"
            + "create_time DATETIME NOT NULL COMMENT '创建时间',"
            + "update_time DATETIME NOT NULL COMMENT '修改时间',"
            + "PRIMARY KEY (`id`), "
            + "UNIQUE uk_name (`name`)"
            + ") ENGINE=InnoDB CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='sky发号器区间表';";
